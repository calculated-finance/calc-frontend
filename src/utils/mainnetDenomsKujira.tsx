...
export const mainnetDenomsKujira: Record<MainnetDenoms, Partial<DenomInfo>> = {
  ...
  [MainnetDenoms.WETH]: {
    ...
    stable: false,
    coingeckoId: 'weth',
    fromAtomic: (value: number) => value / 10 ** 18,
    toAtomic: (value: number) => Math.round(value * 10 ** 18),
  ...
  [MainnetDenoms.DOT]: {
    ...
    enabled: true,
    fromAtomic: (value: number) => value / 10 ** 10,
    toAtomic: (value: number) => Math.round(value * 10 ** 10),
  ...
  [MainnetDenoms.wTAO]: {
    ...
    enabled: true,
    fromAtomic: (value: number) => value / 10 ** 9,
    toAtomic: (value: number) => Math.round(value * 10 ** 9),
  ...
  [MainnetDenoms.wBTC]: {
    ...
    stable: false,
    enabled: true,
    fromAtomic: (value: number) => value / 10 ** 8,
    toAtomic: (value: number) => Math.round(value * 10 ** 8),
