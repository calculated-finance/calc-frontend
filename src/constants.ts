...
export const REST_ENDPOINT = 'https://lcd.harpoon.kujira.setten.io'
export const RPC_ENDPOINT = 'https://rpc.harpoon.kujira.setten.io'
export const CHAIN_ID = 'harpoon-4'