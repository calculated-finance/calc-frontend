    ...
    describe('renders first question correctly', () => {
      describe('Buy strategies', () => {
        it('DCA In', async () => {
          ...
          expect(screen.getByText('How will you fund your first investment?')).toBeInTheDocument();
        });
        it('DCA+ In', async () => {
          mockUseWallet(mockGetPairs(), jest.fn(), jest.fn());
      ...
      describe('Sell strategies', () => {
        it('Weighted Scale Out', async () => {
          ...
          expect(screen.getByText('What position do you want to take profit on?')).toBeInTheDocument();
        });
      });
    });
