...
interface LinkItem {
  ...
  active?: boolean;
  href: ControlDeskPages;
  exclude?: Chains[];
}

const LinkItems: Array<LinkItem> = [
  // { name: 'Home', icon: HomeIcon, href: ControlDeskPages.Home },
  { name: 'Create strategy', icon: Add1Icon, href: ControlDeskPages.CreateStrategy },
  // {
  //   name: 'Pro strategies',
  //   icon: CrownIcon,
  //   href: ControlDeskPages.ProStrategies,
  //   child: (
  ...
  //   ),
  // },
  { name: 'Dashboard', icon: PieChartIcon, href: ControlDeskPages.Dashboard },
  { name: 'My strategies', icon: ToolkitIcon, href: ControlDeskPages.Strategies },
  // { name: 'Bridge assets', icon: BoxedImportIcon, href: ControlDeskPages.GetAssets },
  // { name: 'Settings', icon: SettingsIcon, href: ControlDeskPages.Settings },
...
const getLinkItems = (isAdmin: boolean) => [
  ...
  // ...(isAdmin
  //   ? [
  //     { name: 'Stats & totals', icon: Graph2Icon, href: ControlDeskPages.StatsAndTotals },
  //     { name: 'All strategies', icon: ViewListIcon, href: ControlDeskPages.AllStrategies },
  //   ]
  //   : []),
  // ...(featureFlags.learningHubEnabled
  //   ? [{ name: 'Learning hub', icon: KnowledgeIcon, href: ControlDeskPages.LearnAboutCalc }]
  //   : []),
];
...
export default function SidebarControlDesk({ children }: { children: ReactNode }) {
