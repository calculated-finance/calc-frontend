...
function SquidModalContent() {
  ...
  return (
    <ModalContent mx={6} width={420} height={641}>
      <ModalHeader>Bridge ETH now</ModalHeader>
      <ModalCloseButton />
      <ModalBody px={0} pb={8}>
        {connected ? (
          <iframe
