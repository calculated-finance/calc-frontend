...
export default function SwapAmountControlDesk({ isEdit, initialDenom, resultingDenom, initialDeposit }: { initialDenom: DenomInfo, resultingDenom: DenomInfo, initialDeposit: number, isEdit: boolean }) {
