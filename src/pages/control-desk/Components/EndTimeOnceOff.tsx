...
export default function EndTime({ title, subtitle }: { title: string; subtitle?: string }) {
  const [field, meta] = useField({ name: 'endTime' });
  const [startDateField] = useField({ name: 'endDate' });
