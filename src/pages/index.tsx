import { Button, Box, Heading, Text, Stack, Center, ButtonGroup, Wrap, WrapItem, Image, Flex, Container, Divider } from '@chakra-ui/react'
import { ReactElement } from 'react'
import Layout, { getSidebarLayout } from '../components/Layout'
  ...
  return (
    <Stack spacing={12} direction="column">
        ...
        <WrapItem rounded={5} w="xl" layerStyle={'panel'} h='min-content'>
          <Stack direction={"row"} spacing={4}>
            <Box roundedLeft={5} p={2} bg='black'>
              <Image src={'images/layers.svg'} ></Image>
            </Box>
            <Stack spacing={4} p={4}>
              <Heading size="md">
      ...
      <Stack rounded={5} direction="row" layerStyle={'panel'} p={4} spacing={4}>
        <Image src='images/lightbulb.svg' ></Image>
        ...
        <WrapItem rounded={5} w="3xl" layerStyle={'panel'}>
          <Flex direction={'column'} w='full'>
            ...
            <Flex bg="black" p={4} w='full' justifyContent={'center'}>
              <Image src="images/workflow.svg"></Image>
            </Flex>
          </Flex>
        </WrapItem>
      </Wrap>
