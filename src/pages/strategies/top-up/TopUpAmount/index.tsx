...
export default function TopUpAmount({ initialDenom, swapAmount }: { initialDenom: Denom, swapAmount: number }) {
  const [field, meta] = useField({ name: 'topUpAmount' });
  const additionalSwapAmount = Math.ceil((field.value)/(swapAmount/1e6));
