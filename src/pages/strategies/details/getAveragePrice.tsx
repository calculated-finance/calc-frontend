...
export function getAveragePrice(strategy: Vault, strategyEvents: Event[], resultingDenomPrice: number) {
  return (getTotalReceived(strategy) / getTotalCost(strategy, strategyEvents)) * resultingDenomPrice;
}
