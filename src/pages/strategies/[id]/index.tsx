import { Badge, Button, Center, Divider, Heading, Icon, Stack, Wrap, WrapItem, Box, Flex, ButtonGroup } from "@chakra-ui/react"
...
const CreateStrategy: NextPageWithLayout = () => {
  return (
    <>
      ...
      <Heading size='md' pb={6}> Strategy details</Heading>
      <Wrap spacing={8} pb={8}>
        <Panel>
          <Heading size="md">
            Strategy status
          ...
          <Stack direction={'row'} spacing={4} >
            <Badge colorScheme={'green'} p={2} >Active</Badge>
      ...
      <Heading size='md' pb={6}> Strategy performance</Heading>
      <Wrap spacing={8}>
        <Panel>
          <Heading size="md">
            Asset
